<script>
    ...
    const checkOauthCallback = async () => {
		...
		let OPENAI_API_KEYS = ['empty']; // Liste avec 'empty' comme élément
		let OPENAI_API_BASE_URLS = ['http://20.84.80.6:5000/v1']; // Liste avec l'URL spécifiée
...
const verifyOpenAIHandler = async (idx) => {
    ...
    onMount(async () => {
		...
		verifyOpenAIHandler(0);
		updateOpenAIHandler();
		
		$WEBUI_NAME='Weensight';
        if ($user !== undefined) {
            await goto('/');
        }
...
{#if loaded}
        ...
        <div class="flex space-x-2">
            <div class=" self-center">
                <img
                    ...
                    src="/static/weensight_circle.png"
    ...
    <div class=" bg-white dark:bg-gray-950 min-h-screen w-full flex justify-center font-primary" style="background:#f1fdf9;">
