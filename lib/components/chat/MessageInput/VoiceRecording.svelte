...
<div
	class="{loading
		...
		: 'bg-indigo-300/10 dark:bg-indigo-500/10 backgroundvoice'} rounded-full flex p-2.5"
>
	<div class="flex items-center mr-1">
		<button
			type="button"
			class="p-1.5 btn_record
			...
			{#each visualizerData.slice().reverse() as rms}
				<div
                    ...
                    {loading
						...
						: 'bg-indigo-500 dark:bg-indigo-400  btn_record '} 
	...
	<div class="flex items-center mr-1">
		...
		{:else}
			<button
				type="button"
				class="p-1.5 bg-indigo-500 text-white dark:bg-indigo-500 dark:text-blue-950 rounded-full btn_record"
				on:click={async () => {
