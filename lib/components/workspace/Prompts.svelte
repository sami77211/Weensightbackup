<script lang="ts">
	...
	import Listitem from './PromptListItem.svelte';
...
<div class=" my-16">
	...
	>
		<div class=" self-center w-10 flex-shrink-0 ">
			<div
				class="w-full h-10 flex justify-center rounded-full bg-transparent dark:bg-gray-700 border border-dashed border-gray-200 Plus"
			>
...
<style>
	...
	.custom-bg {
	    background-color: rgba(128, 185, 116, 0.4); /* Couleur de fond plus foncée */
  border: 2px solid rgba(128, 185, 116, 0.6); /* Bordure plus foncée */
